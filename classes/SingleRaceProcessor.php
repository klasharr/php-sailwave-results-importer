...
class SingleRaceProcessor extends AbstractProcessor {
    ...
    public function parseContents(){
        ...
        $row_mapping = new SingleRaceCSVRowMapping($this->raw_file_contents_as_array[0]);
        ...
        foreach($this->raw_file_contents_as_array as $i => $row){
            ...
            $data[] = NormaliseData::getCupRaceRow($row, $row_mapping);
